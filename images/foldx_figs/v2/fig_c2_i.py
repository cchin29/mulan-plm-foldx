"""Ci — late concat of a WT-3Di block, between the embedder and Light Attention."""
...
# ---- what Ci adds: the concat, in the reserved gap ------------------------
gap = []
...
o.append(text(C1, DY + 434, "its 3Di — is tab Ciii. It is a structurally guaranteed no-op.", 11, INK_SOFT, anchor="start"))
...
write(str(_OUT / "fig_c2_i_late_concat.svg"), W, H, "".join(o))
print("ok")

"""Ciii — structure fused into the input token, and the attempt to make it mutation-specific."""
...
# ---- what Ciii adds: the fused token, before the embedder -----------------
pre = []
...
# the same string for the wild type and the mutant (the point Ci makes).
...
o.append(arch("Ciii", pre="".join(pre)))
...
write(str(_OUT / "fig_c2_iii_input_fusion.svg"), W, H, "".join(o))
print("ok")

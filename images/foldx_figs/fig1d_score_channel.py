"""Figure 1d — a physics ΔΔG into the head's add_scores slot."""
...
H = 1046
o = [header("1d")]
o.append(arch("1d", slot_mark=True))

DY = 500
o.append(detail(DY, 504, "The FoldX arms — computation and entry point",
                "Physics computed from structure alone: no learning, model-independent, computed once and reused across every backbone and every split.   ·   Full term list, configs and coverage: Figure A1."))
...
write(str(_OUT / "fig1d_score_channel.svg"), W, H, "".join(o))
print("ok")
